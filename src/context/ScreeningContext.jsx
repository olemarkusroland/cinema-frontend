...
export const ScreeningProvider = ({ children }) => {
    const [screenings, setScreenings] = useState([
        { id: 1, date: dayjs().format('YYYY-MM-DD'), time: '13:00', auditorium: 'HALL 2', movieId: 2 },
        { id: 2, date: dayjs().format('YYYY-MM-DD'), time: '11:00', auditorium: 'HALL 1', movieId: 1 },
        { id: 3, date: dayjs().format('YYYY-MM-DD'), time: '15:00', auditorium: 'HALL 1', movieId: 1 },
        { id: 4, date: dayjs().format('YYYY-MM-DD'), time: '17:00', auditorium: 'HALL 1', movieId: 2 },
        { id: 5, date: dayjs().format('YYYY-MM-DD'), time: '19:00', auditorium: 'HALL 1', movieId: 1 },
        { id: 6, date: dayjs().format('YYYY-MM-DD'), time: '21:00', auditorium: 'HALL 1', movieId: 2 },
        { id: 7, date: dayjs().format('YYYY-MM-DD'), time: '23:00', auditorium: 'HALL 1', movieId: 1 },
        { id: 8, date: dayjs().format('YYYY-MM-DD'), time: '10:00', auditorium: 'HALL 2', movieId: 1 },
